...
import { getInitialUserData } from "@/app/profile/actions";
            ...
            {link.text !== "Logout" ? (
              ...
              <button
                className={clsx(
                  ...
                  'after:content-[""] after:absolute after:left-0 after:-bottom-1 after:h-1 after:w-full after:scale-x-0 after:bg-violet-700 hover:text-violet-400 after:transition-transform after:duration-300 after:ease-out',
